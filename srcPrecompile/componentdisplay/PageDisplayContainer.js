import {getSaveBar} from "/apogeejs-app-bundle/src/componentdisplay/toolbar.js";
import {DATA_DISPLAY_CONSTANTS} from "/apogeejs-app-lib/src/apogeeAppLib.js";
...
export default class PageDisplayContainer {
    ...
    setMainComponentView(componentView) {
        ...
        if((!this.viewModeInfo.childPath)||(this.viewModeInfo.childPath == ".")) {
            this.viewComponentView = this.mainComponentView;
            this.viewComponentId = mainComponent.getId();
        }
        else {
